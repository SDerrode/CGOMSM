...
nohup python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 2:0.07:0.275:0.05     1,1,0 500  4 20 1 0 > serie2_F.out & #--> 48%

python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 2:0.07:0.16:0.05      1,1,0 500 0,1,2,3,4,5 5 1 0    > serie2_F.out &
python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 4:0.15:0.65:0.15:0.15 1,1,0 500 2,5,7,10,14 5 1 0    > serie4_F.out &
python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 4:0.15:0.65:0.15:0.15 1,1,0 500 0,1,2,3,5,7,10 5 1 0 > serie4_F.out &
...
rm ./Result/Fuzzy/Figures/*.png && python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 4:0.15:0.60:0.20:0.20 1,1,0 81 5 1 2 1
...
#   - de mettre seed(None)
#   - verififer le dpi == 300
#nohup python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 4:0.15:0.60:0.20:0.20 1,1,0 300 1,2,3,5,7,9 50 1 0 > courbe.out &
nohup python3 Test_CGOFMSM.py Parameters/Fuzzy/SP2018.param 2:0.07:0.16:0.05 1,1,0 300 0,1,2,3,5,7,9 50 1 0 > courbe.out &
